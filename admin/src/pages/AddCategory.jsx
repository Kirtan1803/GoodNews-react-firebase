                                    ...
                                    <div className="card-body p-0">
                                        <div className="row g-0 h-100">
                                            <div className="col-lg-12 border-end">
                                                <h4 className="card-title fs-16 mb-0 pt-3 ps-4">Create New Category</h4>
                                                <form className="p-4 pt-3">
                                                    ...
                                                    <div className="form-group mb-3">
                                                        ...
                                                        <textarea onChange={(e) => setDesc(e.target.value)} value={desc} class="form-control" rows="5" id="pro-message" placeholder="Enter description here.."></textarea>

                                                    </div>{/*end form-group*/}
                                                    <button onClick={addCategory} type="button" className="btn btn-sm btn-primary me-3">Save category</button>

                                        ...
                                        <div className="row g-0 h-100">
                                            <div className="col-lg-12 border-end">
                                                ...
                                                <form className="p-4 pt-3">
                                                    ...
                                                    <div className="form-group">
                                                        <div className="row">
                                                            <div className="col-lg-12 mb-2 mb-lg-1">
                                                                ...
                                                                <input onChange={(e) => setPwd(e.target.value)} value={pwd} type="password" className="form-control" id="projectName" aria-describedby="emailHelp" placeholder="Enter author password" />
                                                            </div>{/*end col*/}
                                                    ...
                                                    <button onClick={addAuthor} type="button" className="btn btn-sm btn-primary me-3">Save author</button>
